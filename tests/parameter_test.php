...
//            'bar',
    ...
    public function testGetHelp_1()
    {
        $res = array(
            'short'   => 'No help available.',
  	        'long'    => 'Sorry, there is no help text available for this parameter.',
  			'usage'   => 'You may pass arguments to the program when using this parameter.
The parameter does not expect any value.
This parameter may only be used once.',
  			'aliases' => 'The parameter --testing is an alias to this parameter.',
        );
        $this->assertEquals( 
            $this->consoleParameter->getHelp( 't' ),
            $res,
            'Help texts not generated correctly.'
        );
    }
    
    public function testGetHelp_2()
    {
        $res = array(
            'short'   => 'Some stupid short text.',
            'long'    => 'Some even more stupid, but somewhat longer long describtion.',
...
This parameter may be used multiple times.',
            'aliases' => 'The parameter --yank is an alias to this parameter.',
        );
        $this->assertEquals( 
            $this->consoleParameter->getHelp( 'y' ),
            $res,
            'Help texts not generated correctly.'
        );
    }
    
    public function testGetHelp_3()
    {
        foreach ( $this->testAliasesSuccess as $alias )
        {
            $this->consoleParameter->registerAlias( $alias['short'], $alias['long'], $alias['ref'] );
...
The parameter does not expect any value.
This parameter may only be used once.',
            'aliases' => 'The parameters -n, --testing, --nothing are aliases to this parameter.',
        );
        $this->assertEquals( 
            $this->consoleParameter->getHelp( 't' ),
            $res,
...
This parameter may only be used once.',
        ...
        $this->assertEquals( 
            $this->consoleParameter->getHelp( 'n' ),
            $res,
            'Help texts not generated correctly.'
        );
    }
